		...
		<div class="container-editprofile">
			<div class="row-main">
				...
				<input type="hidden" class="text" id="id" name="id"  required value="<c:out value='${showmember.id}' />">
					...
					<p>
					<%-- 	<input class="textdes" id="description" name="description" placeholder="" value="<c:out value='${description}' />" > --%>
					...
					<button class="btn_reset" type="button" onclick="onClear()">Reset Button</button>
				</div>
				</form>
